    ...
    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      <td class="px-4 py-3">
        <?php
            $estado = $orden['estado'];
            $badgeClass =
              $estado === 'pagada' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' :
              ($estado === 'cancelada' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' :
      ...
      <td class="px-4 py-3">
        <a href="../index.php?page=detalleOrder&id=<?= $orden['id'] ?>"
