<div class="container mx-auto py-6">
    <div class="bar-header mb-6">
        <h2 class="text-center text-3xl font-bold mb-0 flex items-center justify-center gap-2 text-gray-800 dark:text-white">
            <i class="bi bi-cup-straw text-blue-500 text-4xl"></i> Vista Bar <span class="hidden sm:inline">(Bebidas)</span>
        </h2>
    </div>
        ...
        fetch('controllers/bar_ajax.php')
            ...
            <div class="overflow-x-auto">
                ...
                <td class="px-2 py-2 text-center">
                    <form class="marcar-preparado-form-bar flex items-center gap-2 justify-center" data-op="${item.op_id}">
